...
public class EnumerationTypeParser extends TypeSpecificationParser
{
    ...
    // Synchronization set to start an enumeration definition.
     ...
     * @param enumerationType the enumerations type specifications.
        ...
        throws Exception
    {
        ...
        if (tokenType == IDENTIFIER) {
            ...
            if (constantId != null) {   // there was already an available entry
