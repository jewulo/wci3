...
public class ExpressionParser extends PascalParserTD
{
    ...
    private static final HashMap<PascalTokenType, ICodeNodeTypeImpl>
        ADD_OPS_MAP = new HashMap<PascalTokenType, ICodeNodeTypeImpl>();
    static {
    ...
    private ICodeNode parseTerm(Token token)
        throws Exception
    {
        // Parse a factor and make it the root node.
        ...
        throws Exception
    {
        ...
        switch ((PascalTokenType) tokenType) {
            case IDENTIFIER: {
                // Look up identifier in the symbol table stack.
            ...
            case NOT:  {
                ...
                // Create a NOT_CONSTANT node as the root node.
