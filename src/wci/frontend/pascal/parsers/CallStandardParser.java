 ...
 *
 * <p> Parse a call to a standard procedure or function.</p>
 */
...
public class CallStandardParser extends CallParser
{
    ...
    /**
     * Parse a call to a declared (standard?) procedure or function.
            ...
            throws Exception
    {
        ...
        token = nextToken();    // consume procedure or a function identifier
        ...
        switch ((RoutineCodeImpl) routineCode) {
            ...
            case WRITE:
            case WRITELN:   return pasrseWriteWriteln(token, callNode, pfId);
     ...
     * @throws Exception if an error occurred.
     */
    private ICodeNode pasrseWriteWriteln(Token token, ICodeNode callNode, SymTabEntry pfId)
            throws Exception
    {
        // Parse any actual parameters.
        ICodeNode parmsNode = parseActualParameters(token, pfId,
        ...
        throws Exception
    {
        ...
        // There should be one integer or real number.
            ...
            throws Exception
    {
        ...
        // There should one integer or real parameter.
        ...
        throws Exception
    {
        ...
        // The function return type is a character.
        if (checkParmCount(token, parmsNode, 1)) {
            TypeSpec argType =
                parmsNode.getChildren().get(0).getTypeSpec().baseType();
    ...
    /**
     * Parse a call to a round or trunc.
     * @param token the current token.
     * @param callNode the CALL node.
     * @param pfId the symbol table entry of the standard routine name.
     * @return ICodeNode the CALL node.
