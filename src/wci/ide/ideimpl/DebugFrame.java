    ...
    implements ActionListener
{
    ...
    public DebugFrame(IDEControl control)
    {
        ...
        listing.setCellRenderer(new ListLineRenderer());
    ...
    {
        messageTitledBorder =
                new TitledBorder(BorderFactory.createLineBorder(new Color(153, 153, 153),2),
    ...
    /**
     * Set the debugger to break at listing line.
     * @param lineNumber the line number.
     */
    ...
    private class ListingLine
    {
        ...
        /**
         * @return true if breakpoint, else false
         */
    ...
    private ImageIcon nobreakIcon = new ImageIcon("..\\icons\\nobreak.gif");
    private ImageIcon breakableIcon = new ImageIcon("..\\icons\\breakable.gif");
    private ImageIcon breakPointIcon = new ImageIcon("..\\icons\\breakpoint.gif");

    private class ListLineRenderer
        extends JLabel
