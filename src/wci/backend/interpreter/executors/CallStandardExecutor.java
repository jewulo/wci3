...
/**
 * <h1>CallStandardExecute</h1>
 *
 * <p>Execute a call to a standard procedure or function.</p>
 */
public class CallStandardExecutor extends CallExecutor
{
        ...
        throws Exception
    {
        ...
        if (tokenType == INTEGER) {
            ...
            return type == Predefined.integerType ? value
        ...
        // Real value.
            ...
            return type == Predefined.realType ? value
    ...
    private Number executeAbsSqr(ICodeNode callNode, RoutineCode routineCode, ICodeNode actualNode)
    {
        ...
        if (argValue instanceof Integer) {
            ...
            return routineCode == ABS ? Math.abs(value)
                                      : value * value;
        }
        else {
    ...
    {
        int value = (Integer) expressionExecutor.execute(actualNode);
        return (value & 1) == 1;    // test first bit of number (zeroth bit)
    }
