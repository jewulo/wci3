...
public class ProgramGenerator extends CodeGenerator
{
    ...
    /**
     * Generate directives for fields.
     */
    private void generateFields()
    {
        // Runtime and standard in.
        emitBlankLine();
    ...
    {
        emitBlankLine();
        emitDirective(METHOD_PUBLIC_STATIC, "main([Ljava/land/String;)V");
