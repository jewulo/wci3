...
public class DeclaredRoutineGenerator extends CodeGenerator
{
     ...
     * @param routineId the symbol table entry of the routine's entry.
     */
    ...
    private void generateRoutineHeader()
    {
        ...
        emitBlankLine();
        emitDirective(METHOD_PRIVATE_STATIC, buffer.toString()); // emit the routine header
    }
    ...
    /**
     * Generate the routine's return epilogue.
     */
