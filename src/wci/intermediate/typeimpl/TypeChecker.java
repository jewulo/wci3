...
{
    // There is no constructor. Only static methods.

    /**
     * Check if type specification is integer.
    ...
    /**
     * Check if the type specification is real.
     * @param type the type specification to check.
    ...
    /**
     * Check if a type specifications is integer or real.
     * @param type the specification to check.
    ...
    /**
     * Check if at least one of the two type specifications is real.
     * @param type1 the first specification to check.
    ...
    /**
     * Check if both specifications are boolean.
     * @param type1 the first type specification to check.
     * @param type2 the second type specification to check.
